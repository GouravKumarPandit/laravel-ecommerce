...
class ProductReviewController extends Controller
{
    public function index()
    {
        $result['data']=
                ...
                ->select('product_review.id', 'products.id as product_id', 'product_review.rating','product_review.review','product_review.added_on','customers.name', 'customers.id as customers_id', 'products.name as pname','product_review.status')
                ->get();
