...
<div class="row m-t-30">
   <div class="col-md-12">
      <form action="{{route('product.manage_product_process')}}" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4 product_images_{{$loop_count_num++}}"  >
							...
							<div class="col-md-2">
								...
								@if($loop_count_num==2)
									<button type="button" class="btn btn-sm btn-success btn-lg" onclick="add_image_more()">
									<i class="fa fa-plus"></i>&nbsp; Add</button>
								@else
								<a href="{{url('admin/product/product_images_delete/')}}/{{$pIArr['id']}}/{{$id}}"><button type="button" class="btn btn-sm btn-danger btn-lg">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-2">
                              ...
                              @if($loop_count_num==2)
                                <button type="button" class="btn btn-sm btn-success btn-lg" onclick="add_more()">
                                <i class="fa fa-plus"></i>&nbsp; Add</button>
                              @else
                              <a href="{{url('admin/product/product_attr_delete/')}}/{{$pAArr['id']}}/{{$id}}"><button type="button" class="btn btn-sm btn-danger btn-lg">
                                <i class="fa fa-minus"></i>&nbsp; Remove</button></a>
                              @endif  
         ...
         <div>
            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block mb-5">
            Submit
            </button>
         </div>
...
<script>
   ...
   function add_more(){
       ...
       html+='<div class="col-md-2"><label for="attr_image" class="control-label mb-1"> &nbsp;&nbsp;&nbsp;</label><button type="button" class="btn btn-sm btn-danger btn-lg" onclick=remove_more("'+loop_count+'")><i class="fa fa-minus"></i>&nbsp; Remove</button></div>'; 
   ...
   function add_image_more(){
      ...
      //product_images_box
       html+='<div class="col-md-2 product_images_'+loop_image_count+'""><label for="attr_image" class="control-label mb-1"> &nbsp;&nbsp;&nbsp;</label><button type="button" class="btn btn-sm btn-danger btn-lg" onclick=remove_image_more("'+loop_image_count+'")><i class="fa fa-minus"></i>&nbsp; Remove</button></div>'; 
