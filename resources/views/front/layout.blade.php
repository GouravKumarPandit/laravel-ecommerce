                        ...
                        <div class="aa-header-bottom-area">
                            ...
                            <div class="aa-logo">
                                ...
                                <a href="{{ url('/') }}">
                                    ...
                                    <p>Local<strong>Shop</strong> <span>Your Shopping Partner</span></p>
                                </a>
                            </div>
                            ...
                            <div class="aa-search-box">
                                <form action="">
                                    <input type="text" id="search_str" placeholder="Search Product...">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="aa-footer-widget">
                                        <div class="aa-footer-widget">
                                            <h3>Contact Us</h3>
                                            <address>
                                                <p> 56 Dhrdeyf Pl, NY 122134, USA</p>
                                                <p><span class="fa fa-phone"></span>+0 000-000-0000</p>
                                                <p><span class="fa fa-envelope"></span>panditgourav452@gmail.com</p>
                                            </address>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="aa-footer-bottom-area">
                            <p>Designed by <a href="https://github.com/GouravKumarPandit">GouravKumarPandit</a></p>
