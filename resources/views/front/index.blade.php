...
@section('container')
                    ...
                    <div class="aa-promo-area">
                        <div class="row">
                            @foreach ($home_categories as $list)
                                <div class="col-sm-6" style="height: 400px !important; margin-top: 35px !important; border-radius: 10px !important;">
    ...
    <!-- Products section -->
    <section id="aa-product" style="margin-top: 50px !important;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                                ...
                                <ul class="nav nav-tabs aa-products-tab">
                                    @foreach ($home_categories as $list)
                                        <li class=""><a href="#cat{{ $list->id }}"
                                                data-toggle="tab"><b>{{ $list->category_name }}</b></a></li>
                                    @endforeach
                                </ul>
                                <!-- Tab panes -->
                                    ...
                                    @foreach ($home_categories as $list)
                                        ...
                                        <div class="tab-pane fade {{ $cat_class }}" id="cat{{ $list->id }}">
                                            <ul class="aa-product-catg">
                                                ...
                                                @else
                                                    <li>
                                                        <h4 class="text-danger font-weight-bolder">No data found</h4> 
                                                    </li>
                                                @endif
                                            </ul>
                                        </div>
